...
TEST_F(AGlobalSimilaritySorterTest, OneList) {
    ...
    ASSERT_EQ((*similarReferencesVector.at(0).similarReferences_.at(1)).ownId(),1);
    ASSERT_EQ((*similarReferencesVector.at(0).similarReferences_.at(2)).ownId(),2);
    ASSERT_EQ((*similarReferencesVector.at(0).similarReferences_.at(3)).ownId(),3);
    ASSERT_EQ((*similarReferencesVector.at(0).similarReferences_.at(4)).ownId(),4);
    ASSERT_EQ((*similarReferencesVector.at(0).similarReferences_.at(5)).ownId(),5);
    ASSERT_EQ((*similarReferencesVector.at(0).similarReferences_.at(6)).ownId(),6);
    ASSERT_EQ((*similarReferencesVector.at(0).similarReferences_.at(7)).ownId(),7);
}
...
TEST_F(AGlobalSimilaritySorterTest, TwoLists) {
    ...
    ASSERT_EQ((*similarReferencesVector.at(1).similarReferences_.at(1)).ownId(),5);
    ASSERT_EQ((*similarReferencesVector.at(1).similarReferences_.at(2)).ownId(),6);
    ASSERT_EQ((*similarReferencesVector.at(1).similarReferences_.at(3)).ownId(),7);
}
...
TEST_F(AGlobalSimilaritySorterTest, TwoListsIncrementBorderCase) {
    ...
    ASSERT_EQ((*similarReferencesVector.at(1).similarReferences_.at(1)).ownId(),3);

    ASSERT_EQ(similarReferencesVector.at(2).representativeReference().ownId(),4);
    ASSERT_EQ((*similarReferencesVector.at(2).similarReferences_.at(1)).ownId(),5);

    ASSERT_EQ(similarReferencesVector.at(3).representativeReference().ownId(),6);
    ASSERT_EQ((*similarReferencesVector.at(3).similarReferences_.at(1)).ownId(),7);
}
