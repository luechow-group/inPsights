...
TEST_F(AGlobalIdentitySorterTest, OneListTriplet) {
    ...
    ASSERT_THAT(tripletMaxima.at(0).sampleIds_, ElementsAre(1,2,3,4,5,6,7));
}
...
TEST_F(AGlobalIdentitySorterTest, OneListSinglet) {
    ...
    ASSERT_THAT(singletMaxima.at(0).sampleIds_, ElementsAre(1,2,3,4,5,6,7));
}
...
TEST_F(AGlobalIdentitySorterTest, TwoListsTriplet) {
    ...
    ASSERT_THAT(tripletMaxima.at(0).sampleIds_, ElementsAre(1,2,3));
...
TEST_F(AGlobalIdentitySorterTest, TwoListsSinglet) {
    ...
    ASSERT_THAT(singletMaxima.at(0).sampleIds_, ElementsAre(1,2,3));
...
TEST_F(AGlobalIdentitySorterTest, TwoListsIncrementBorderCaseTriplet) {
    ...
    ASSERT_THAT(tripletMaxima.at(0).sampleIds_, ElementsAre(1,2,3,4));
    ASSERT_THAT(tripletMaxima.at(1).sampleIds_, ElementsAre(6,7));
}
...
TEST_F(AGlobalIdentitySorterTest, TwoListsIncrementBorderCaseSinglet) {
    ...
    ASSERT_THAT(singletMaxima.at(0).sampleIds_, ElementsAre(1,2,3,4));
    ASSERT_THAT(singletMaxima.at(1).sampleIds_, ElementsAre(6,7));
}
