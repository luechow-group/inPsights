...
const std::string Pse::pse[118]={"H","He","Li","Be","B","C","N","O","F","Ne","Na","Mg","Al","Si","P","S","Cl","Ar","K","Ca","Sc",
...
int Pse::findElement(std::string &elementType) {
    for(int i=0;i<118;i++){
        if(!elementType.compare(pse[i]))return i+1;
    }
    return 0;
}
