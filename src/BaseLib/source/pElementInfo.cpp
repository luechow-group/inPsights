...
namespace Elements {
    ...
    namespace internal {
        ...
        void pElementInfo::init_data() {
            ...
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::P,  ElementData("P" ,  15, 30.974, {255,128, 00}, 180.0,  5, 6, 9, 0, 0)));
            ...
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Sc, ElementData("Sc",  21, 44.956, {230,230,230},    -1,  3, 8,12, 1, 0)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Ti, ElementData("Ti",  22, 47.867, {191,194,199},    -1,  4, 8,12, 2, 0)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::V,  ElementData("V" ,  23, 50.942, {166,166,171},    -1,  5, 8,12, 3, 0)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Cr, ElementData("Cr",  24, 51.996, {138,153,199},    -1,  6, 7,12, 5, 0)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Mn, ElementData("Mn",  25, 54.938, {156,122,199},    -1,  7, 8,12, 5, 0)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Fe, ElementData("Fe",  26, 55.938, {224,102, 51},    -1,  8, 8,12, 6, 0)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Co, ElementData("Co",  27, 58.933, {240,144,160},    -1,  9, 8,12, 7, 0)));
            ...
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Y,  ElementData("Y" ,  39, 88.906, {135,255,255},    -1,  3,10,18,11, 0)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Zr, ElementData("Zr",  40, 91.224, {117,234,234},    -1,  4,10,18,12, 0)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Nb, ElementData("Nb",  41, 92.906, { 98,213,215},    -1,  5, 9,18,14, 0)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Mo, ElementData("Mo",  42, 95.96 , { 79,192,196},    -1,  6, 9,18,15, 0)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Tc, ElementData("Tc",  43, 98.91 , { 60,171,179},    -1,  7,10,18,15, 0)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Ru, ElementData("Ru",  44, 101.07, { 40,150,163},    -1,  8, 9,18,17, 0)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Rh, ElementData("Rh",  45, 102.91, { 20,128,148},    -1,  9, 9,18,18, 0)));
            ...
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::La, ElementData("La",  57, 138.91, {237,183, 84},    -1,  3,12,24,21, 0)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Ce, ElementData("Ce",  58, 140.12, {228,187, 83},    -1,  4,12,24,21, 1)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Pr, ElementData("Pr",  59, 140.91, {221,181, 80},    -1,  5,12,24,20, 3)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Nd, ElementData("Nd",  60, 144.24, {214,169, 77},    -1,  6,12,24,20, 4)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Pm, ElementData("Pm",  61, 146.90, {207,155, 73},    -1,  7,12,24,20, 5)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Sm, ElementData("Sm",  62, 150.36, {201,140, 68},    -1,  8,12,24,20, 6)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Eu, ElementData("Eu",  63, 151.96, {195,126, 64},    -1,  9,12,24,20, 7)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Gd, ElementData("Gd",  64, 157.25, {190,112, 59},    -1, 10,12,24,21, 7)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Tb, ElementData("Tb",  65, 158.93, {184,100, 55},    -1, 11,12,24,20, 9)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Dy, ElementData("Dy",  66, 162.50, {179, 89, 51},    -1, 12,12,24,20,10)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Ho, ElementData("Ho",  67, 164.93, {173, 79, 48},    -1, 13,12,24,20,11)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Er, ElementData("Er",  68, 167.26, {166, 71, 45},    -1, 14,12,24,20,12)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Tm, ElementData("Tm",  69, 168.93, {156, 64, 44},    -1, 15,12,24,20,13)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Yb, ElementData("Yb",  70, 173.05, {142, 60, 45},    -1, 16,12,24,20,14)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Lu, ElementData("Lu",  71, 174.97, {121, 58, 47},    -1, 17,12,24,21,14)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Hf, ElementData("Hf",  72, 178.49, {199,183,183},    -1, 18,12,24,22,14)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Ta, ElementData("Ta",  73, 180.95, {187,139,174},    -1, 19,12,24,23,14)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::W,  ElementData("W" ,  74, 183.84, {174, 92,162},    -1, 20,12,24,24,14)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Re, ElementData("Re",  75, 186.21, {154, 94,142},    -1, 21,12,24,25,14)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Os, ElementData("Os",  76, 190.23, {133, 97,120},    -1, 22,12,24,26,14)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Ir, ElementData("Ir",  77, 192.22, {114, 95,102},    -1, 23,12,24,27,14)));
            ...
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Ac, ElementData("Ac",  89, 227   , { 82,183,252},    -1,  3,14,30,31,14)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Th, ElementData("Th",  90, 232.04, { 92,171,240},    -1,  4,14,30,32,14)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Pa, ElementData("Pa",  91, 231.04, {101,160,229},    -1,  5,14,30,31,16)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::U,  ElementData("U" ,  92, 238.03, {110,149,218},    -1,  6,14,30,31,17)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Np, ElementData("Np",  93, 237.05, {118,139,208},    -1,  7,14,30,31,18)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Pu, ElementData("Pu",  94, 244.10, {126,129,197},    -1,  8,14,30,30,20)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Am, ElementData("Am",  95, 243.10, {133,120,188},    -1,  9,14,30,30,21)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Cm, ElementData("Cm",  96, 247.10, {140,111,178},    -1, 10,14,30,30,23)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Bk, ElementData("Bk",  97, 247.10, {146,102,169},    -1, 11,14,30,30,23)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Cf, ElementData("Cf",  98, 251.10, {152, 94,160},    -1, 12,14,30,30,24)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Es, ElementData("Es",  99, 254.10, {157, 86,151},    -1, 13,14,30,30,25)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Fm, ElementData("Fm", 100, 257.10, {162, 78,143},    -1, 14,14,30,30,26)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Md, ElementData("Md", 101, 258   , {166, 71,135},    -1, 15,14,30,30,27)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::No, ElementData("No", 102, 259   , {169, 65,128},    -1, 16,14,30,30,28)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Lr, ElementData("Lr", 103, 262   , {172, 59,120},    -1, 17,14,30,31,28)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Rf, ElementData("Rf", 104, 261   , {174, 53,114},    -1, 18,14,30,32,28)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Db, ElementData("Db", 105, 262   , {176, 47,107},    -1, 19,14,30,33,28)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Sg, ElementData("Sg", 106, 266   , {178, 42,101},    -1, 20,14,30,34,28)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Bh, ElementData("Bh", 107, 264   , {179, 38, 95},    -1, 21,14,30,35,28)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Hs, ElementData("Hs", 108, 277   , {179, 34, 90},    -1, 22,14,30,36,28)));
            d_container.insert(std::pair<ElementType,ElementData>(ElementType::Mt, ElementData("Mt", 109, 268   , {179, 30, 84},    -1, 23,14,30,37,28)));
