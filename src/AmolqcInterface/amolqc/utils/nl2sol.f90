...
!
  ...
  real*8, save :: dgxfac = 0.0D+00
  integer diag
  integer diag0
  real*8 dig(p)
  real*8 dihdi((p*(p+1))/2)
  real*8 dotprd
  real*8 dst
  ...
  integer emax
  integer emin
  real*8, parameter :: epsfac = 50.0D+00
  ...
  integer ka
  integer kalim
  real*8, parameter :: kappa = 2.0D+00
  real*8 l((p*(p+1))/2)
  real*8 lk
  integer lk0
  real*8 lsvmin
...
!
  ...
  real*8 d1
  real*8 d2
  real*8, parameter :: dfac = 256.0D+00
  real*8 dfacsq
  integer, parameter :: dgnorm = 1
  real*8 dotprd
  real*8 dst
...
!
  ...
  integer uiparm(*)
  real*8 urparm(*)
  real*8 v(93 + n*p + 3*n + (p*(3*p+33))/2)
  real*8 x(p)
...
!
  ...
  real*8 h
  real*8, parameter :: hfac = 1000.0D+00
  real*8, save :: hlim = 0.0D+00
  integer i
  integer iv(60+p)
  integer, parameter :: j = 33
  integer j1
...
!
  ...
  real*8 qrkk
  real*8 qrkmax
  real*8, save :: rktol = 0.0D+00
  real*8 rktol1
  real*8 sigma
  real*8 sum(n)
  real*8 sumj
  real*8 temp
  real*8, save :: ufeta = 0.0D+00
  real*8 v2norm
