...
! -------------------------------------
  real*8 function ss_meanAllNodes(self)
! -------------------------------------
...
! --------------------------------
  real*8 function ss_variance(self)
! --------------------------------
...
! -----------------------------------------
  real*8 function ss_varianceAllNodes(self)
! -----------------------------------------
...
! ----------------------------------
  real*8 function ss_stdDevMean(self)
! ----------------------------------
...
! -------------------------------------------
  real*8 function ss_stdDevMeanAllNodes(self)
! -------------------------------------------
...
! ------------------------------------
  integer*8 function ss_dataCount(self)
! ------------------------------------
...
! ------------------------------------------
  integer*8 function ss_dataCountAllNodes(self)
! ------------------------------------------
...
! ------------------------------
  real*8 function ss_minValue(self)
! ------------------------------
...
! ------------------------------
  real*8 function ss_maxValue(self)
! ------------------------------
...
! -------------------------------------
  real*8 function ws_meanAllNodes(self)
! -------------------------------------
...
! --------------------------------
  real*8 function ws_variance(self)
! --------------------------------
...
! -----------------------------------------
  real*8 function ws_varianceAllNodes(self)
! -----------------------------------------
...
! ----------------------------------
  real*8 function ws_stdDevMean(self)
! ----------------------------------
...
! -------------------------------------------
  real*8 function ws_stdDevMeanAllNodes(self)
! -------------------------------------------
...
! ------------------------------------
  integer*8 function ws_dataCount(self)
! ------------------------------------
...
! ------------------------------------------
  integer*8 function ws_dataCountAllNodes(self)
! ------------------------------------------
...
! ------------------------------------
  real*8 function ws_totalWeight(self)
! ------------------------------------
...
! --------------------------------------------
  real*8 function ws_totalWeightAllNodes(self)
! --------------------------------------------
...
! ------------------------------
  real*8 function ws_minValue(self)
! ------------------------------
...
! ------------------------------
  real*8 function ws_maxValue(self)
! ------------------------------
...
! ---------------------------------
  real*8 function bs_blockMean(self)
! ---------------------------------
...
! --------------------------------
  real*8 function bs_variance(self)
! --------------------------------
...
! ----------------------------------
  real*8 function bs_stdDevMean(self)
! ----------------------------------
...
! ------------------------------------
  integer*8 function bs_dataCount(self)
! ------------------------------------
...
! --------------------------------
  real*8 function ih_variance(self)
! --------------------------------
...
! ----------------------------------
  real*8 function ih_stdDevMean(self)
! ----------------------------------
...
! ------------------------------------
  integer*8 function ih_dataCount(self)
! ------------------------------------
...
! ------------------------------
  real*8 function ih_minValue(self)
! ------------------------------
...
! ------------------------------
  real*8 function ih_maxValue(self)
! ------------------------------
...
!================================!
  ...
  type DoubleHistogram
     private
     real*8, pointer  :: bin(:) => null()
     real*8           :: xMin = 0
     real*8           :: xMax = 0
     real*8           :: h = 1         ! step size
     integer          :: n = 0         ! # of bins
     real*8           :: averageSum = 0
     real*8           :: varianceSum = 0
     real*8           :: weightSum = 0
...
! ------------------------------
    ...
    type(DoubleHistogram), intent(in)  :: self
    real*8,pointer                     :: dh_getHistogram(:,:)
    integer i
...
! ----------------------------------
    ...
    ! in getHistogram(2,:) size of bin
    type(DoubleHistogram), intent(in)  :: self
    real*8,pointer                 :: dh_getMeanHistogram(:,:)
    integer i
...
! --------------------------------
  real*8 function dh_variance(self)
! --------------------------------
...
! ----------------------------------
  real*8 function dh_stdDevMean(self)
! ----------------------------------
...
! ------------------------------------
  integer*8 function dh_dataCount(self)
! ------------------------------------
...
! ------------------------------------
  real*8 function dh_totalWeight(self)
! ------------------------------------
...
! ---------------------------------
  real*8 function dh_minValue(self)
! ---------------------------------
...
! ---------------------------------
  real*8 function dh_maxValue(self)
! ---------------------------------
...
! -------------------------------------
    ...
    integer, intent(in)             :: iu    ! file unit to write to
    integer i
    real*8 mean,denom,x,normaldist(0:self%n-1),factor
...
! ------------------------------------
    ...
    type(IndexedHistogram), intent(inout) :: self
    real*8, optional, intent(in)  :: xMin
    real*8, optional, intent(in)  :: xMax
...
! ------------------------------
    ...
    ! in getHistogram(2,:) size of bin
    type(IndexedHistogram), intent(in)  :: self
    real*8,pointer                     :: idh_getHistogram(:,:)
    integer i
...
! ----------------------------------
    ...
    ! in getHistogram(2,:) size of bin
    type(IndexedHistogram), intent(in)  :: self
    real*8,pointer                 :: idh_getMeanHistogram(:,:)
    integer i
...
! --------------------------------
  real*8 function idh_variance(self)
! --------------------------------
...
! ----------------------------------
  real*8 function idh_stdDevMean(self)
! ----------------------------------
...
! ------------------------------------
  integer*8 function idh_dataCount(self)
! ------------------------------------
...
! ---------------------------------
  real*8 function idh_minValue(self)
! ---------------------------------
...
! ---------------------------------
  real*8 function idh_maxValue(self)
! ---------------------------------
...
! -----------------------------------------
  ...
  !--------------------------------------------------------------------!
    ...
    real*8, intent(out)                 :: leftProb,rightProb
    real*8 norm,mean,denom,x,normaldist
    integer i,kl,kr,j
