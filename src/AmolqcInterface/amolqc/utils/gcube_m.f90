...
MODULE gcube_module
    ...
    type gcube
        real*8, pointer  :: bins(:,:,:) => null()    ! actual bins
        real*8           :: ax=0,bx=0,ay=0,by=0,az=0,bz=0           ! lower/upper borders
        real*8           :: hx=0,hy=0,hz=0           ! step size
        integer          :: n=0                      ! # of bins per dimension
        character(len=80):: line1="cube file generated by gcube_module"
        character(len=80):: line2="outer loop x, middle y, inner z"
        integer          :: ncenter=0                ! molecule: # atoms
        real*8, pointer  :: cx(:) => null()          ! x,y,z coords
        real*8, pointer  :: cy(:) => null()
...
contains
    ...
    real*8 function gcube_getData(this,ix,iy,iz)
        class(gcube), intent(inout) :: this
    ...
    subroutine gcube_reduceAllNodes(this)
        class(gcube), intent(inout) :: this
        real*8                     :: sendbuf(this%n**3),recvbuf(this%n**3)
        integer            :: c,i,j,k
        ...
        enddo
        recvbuf = 0
        call myMPIAllReduceSumDouble(sendbuf,recvbuf,this%n**3)
        c = 1
        do i =0,this%n-1
            do j=0,this%n-1
                do k=0,this%n-1
...
102         format((6E13.5))
    ...
    subroutine gcube_writeToTrimFile(this,filename)
        ...
        character(len=3) :: idxc
        integer, parameter :: iu=20
        real*8,dimension(:),allocatable :: bins_small
