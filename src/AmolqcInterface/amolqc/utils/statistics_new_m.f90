...
module newstatistics
   ...
   type, public :: stat
      private
      real*8    :: averageSum = 0
      real*8    :: varianceSum = 0
      real*8    :: weightSum = 0
      integer*8 :: dataCounter = 0
   contains
   ...
   type, public :: vectorstat
      private
      real*8,pointer    :: averageSum(:) => null()
      real*8,pointer    :: varianceSum(:) => null()
      real*8            :: weightSum = 0
      integer*8         :: dataCounter = 0
      integer           :: vsize = 0
   contains
   ...
   type, public :: blockvectorstat
      ...
      real*8,pointer   :: lastBlockMeanValue(:) => null()
      integer    :: blockLen = 0
   contains
...
! access functions
   ...
   real*8 function stat_localmean(self)
   ...
   real*8 function stat_mean(self)
#ifdef PARALLEL
      include 'mpif.h'
#endif
      class(stat), intent(in)  :: self
   ...
   real*8 function stat_localvar(self)
      class(stat), intent(in)  :: self
   ...
   real*8 function stat_var(self)
#ifdef PARALLEL
      include 'mpif.h'
#endif
      class(stat), intent(in)  :: self
      real*8 sendbuf(3),recvbuf(3)
      integer ierr,taskid
   ...
   real*8 function stat_localstddev(self)
      class(stat), intent(in)  :: self
   ...
   real*8 function stat_stddev(self)
#ifdef PARALLEL
      include 'mpif.h'
#endif
      class(stat), intent(in)  :: self
   ...
   integer*8 function stat_localcount(self)
      class(stat), intent(in)  :: self
      stat_localcount = self%dataCounter
   end function stat_localcount


   integer*8 function stat_count(self)
#ifdef PARALLEL
      include 'mpif.h'
#endif
      class(stat), intent(in)  :: self
   ...
   real*8 function stat_localweight(self)
      class(stat), intent(in)  :: self
      stat_localweight = self%weightSum
   end function stat_localweight


   real*8 function stat_weight(self)
#ifdef PARALLEL
      include 'mpif.h'
#endif
      class(stat), intent(in)  :: self
...
!!!!!!!!! vstat methods
   ...
   subroutine vstat_addData(self,vdata,vwgt)
      ...
      real*8, intent(in), optional :: vwgt
...
! access functions
...
#endif
      class(vectorstat), intent(in)  :: self
      real*8                    :: mean(self%vsize)
      real*8 sendbuf(self%vsize+1),recvbuf(self%vsize+1)
      integer ierr,taskid
   ...
   function vstat_var(self) result(var)
      ...
      class(vectorstat), intent(in)  :: self
      real*8                    :: var(self%vsize)
      real*8 sendbuf(2*self%vsize+1),recvbuf(2*self%vsize+1)
      integer ierr,taskid
   ...
   function vstat_stddev(self) result(stddev)
      ...
      class(vectorstat), intent(in)  :: self
      real*8                    :: stddev(self%vsize)
      real*8 sendbuf(2*self%vsize+2),recvbuf(2*self%vsize+2)
      integer ierr,taskid
      sendbuf(1:self%vsize) = self%averageSum
      sendbuf(self%vsize+1:2*self%vsize)=self%varianceSum
      sendbuf(2*self%vsize+1) = self%weightSum
   ...
   integer*8 function vstat_localcount(self)
      class(vectorstat), intent(in)  :: self
      vstat_localcount = self%dataCounter
   end function vstat_localcount


   integer*8 function vstat_count(self)
#ifdef PARALLEL
      include 'mpif.h'
#endif
      class(vectorstat), intent(in)  :: self
...
! access functions
   ...
   function bvstat_localmean(self) result(localmean)
      class(blockvectorstat), intent(in)  :: self
      real*8                    :: localmean(self%allBlockStat%vsize)
   ...
   function bvstat_locallastblockmean(self) result(lbmean)
      class(blockvectorstat), intent(in)  :: self
      real*8                    :: lbmean(self%allBlockStat%vsize)
   ...
   function bvstat_mean(self) result(mean)
      class(blockvectorstat), intent(in)  :: self
      real*8                    :: mean(self%allBlockStat%vsize)
   ...
   function bvstat_lastblockmean(self) result(lbmean)
      ...
      class(blockvectorstat), intent(in)  :: self
      real*8                    :: lbmean(self%allBlockStat%vsize)
      real*8 sendbuf(self%allBlockStat%vsize),recvbuf(self%allBlockStat%vsize)
      integer ierr, nproc,n
      sendbuf = self%lastBlockMeanValue
      recvbuf = sendbuf  ! default for serial run
      nproc = 1
   ...
   function bvstat_localvar(self) result(var)
      class(blockvectorstat), intent(in)  :: self
      real*8                              :: var(self%allBlockStat%vsize)
   ...
   function bvstat_localstddev(self) result(stddev)
      class(blockvectorstat), intent(in)  :: self
      real*8                              :: stddev(self%allBlockStat%vsize)
...
! access functions
   ...
   function mstat_localmean(self) result(localmean)
      class(matrixstat), intent(in)  :: self
      real*8                    :: localmean(self%m,self%n)
   ...
   integer*8 function mstat_localcount(self)
      class(matrixstat), intent(in)  :: self
      mstat_localcount = self%dataCounter
   end function mstat_localcount


   integer*8 function mstat_count(self)
#ifdef PARALLEL
      include 'mpif.h'
#endif
      class(matrixstat), intent(in)  :: self
 ...
 !!!!!!!!! block matrix stat methods
   ...
   subroutine bmstat_addData(self,mdata,mwgt)
      class(blockmatrixstat), intent(inout) :: self
      real*8, intent(in)           :: mdata(:,:)
      real*8, intent(in), optional :: mwgt
      integer n
      real*8 mean(size(mdata,1),size(mdata,2))
...
! access functions
   ...
   function bmstat_localmean(self) result(localmean)
      class(blockmatrixstat), intent(in)  :: self
      real*8                    :: localmean(self%allBlockStat%m,self%allBlockStat%n)
      localmean = self%totalStat%localmean()
   ...
   function bmstat_locallastblockmean(self) result(lbmean)
      class(blockmatrixstat), intent(in)  :: self
      real*8                    :: lbmean(self%allBlockStat%m,self%allBlockStat%n)
      lbmean = self%lastBlockMeanValue
   ...
   function bmstat_mean(self) result(mean)
      class(blockmatrixstat), intent(in)  :: self
      real*8                    :: mean(self%allBlockStat%m,self%allBlockStat%n)
      mean = self%totalStat%mean()
   ...
   function bmstat_localvar(self) result(var)
      class(blockmatrixstat), intent(in)  :: self
      real*8                              :: var(self%allBlockStat%m,self%allBlockStat%n)
      var = self%totalStat%localvar()
   ...
   function bmstat_localstddev(self) result(stddev)
      class(blockmatrixstat), intent(in)  :: self
      real*8                              :: stddev(self%allBlockStat%m,self%allBlockStat%n)
      stddev = self%allBlockStat%localstddev()
