...
!
  ...
  type vectorStat
     private
     real*8, pointer   :: dAverageSum(:)
     real*8, pointer   :: dCovarianceSum(:,:)
     integer           :: dVectorSize
...
contains
  ...
  !---------------------!
    ...
    type(vectorStat), intent(in)  :: self
    real*8                        :: variance(self%dVectorSize)
    integer                       :: i
  ...
  !-----------------------!
    ...
    type(vectorStat), intent(in)  :: self
    real*8                        :: covariance(self%dVectorSize,self%dVectorSize)
    real*8                        :: mn(self%dVectorSize)
    integer                       :: i,j
  ...
  !-----------------------!
    ...
    type(vectorStat), intent(in)  :: self
    real*8                        :: stdDevMean(self%dVectorSize)
    integer                       :: i
...
end module vectorStatisticsModule
