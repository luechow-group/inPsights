...
module ElocAndPsiTermsLMModule
   ...
   type, public :: ElocAndPsiTermsLM
      ...
      real*8, pointer :: vxSum(:) => null()
      real*8, pointer :: vxySum(:,:) => null()
...
contains
   ...
   real*8, intent(in)                     :: eRef     ! reference energy
   ...
   !------------------------------------------!
      ...
      if (np /= size(wfpDT%ELi)) call abortp("ElocAndPsiTermsLM_add: inconsistent sizes")
   ...
   !-------------------------------------------!
   real*8 function ElocAndPsiTermsLM_EMean(this)
   !-------------------------------------------!
   type(ElocAndPsiTermsLM), intent(inout) :: this
   ...
   !----------------------------------------------!
   real*8 function ElocAndPsiTermsLM_EMeanALL(this)
   !----------------------------------------------!
   type(ElocAndPsiTermsLM), intent(inout) :: this
   ...
   !-----------------------------------------!
   real*8 function ElocAndPsiTermsLM_var(this)
   !-----------------------------------------!
   type(ElocAndPsiTermsLM), intent(inout) :: this
   ...
   !--------------------------------------------!
   real*8 function ElocAndPsiTermsLM_varRef(this)
   !--------------------------------------------!
   type(ElocAndPsiTermsLM), intent(inout) :: this
   ...
   !--------------------------------------------!
   real*8 function ElocAndPsiTermsLM_varALL(this)
   !--------------------------------------------!
   type(ElocAndPsiTermsLM), intent(inout) :: this
   ...
   !-----------------------------------------------!
   real*8 function ElocAndPsiTermsLM_varRefALL(this)
   !-----------------------------------------------!
   type(ElocAndPsiTermsLM), intent(inout) :: this
   ...
   !------------------------------------!
   type(ElocAndPsiTermsLM), intent(inout) :: this
   real*8  :: ElocAndPsiTermsLM_VxALL(this%EPTB%wfp%nParams)
   integer nData(1),nTotalData(1)
   real*8 VxTotalSum(this%EPTB%wfp%nParams)
   VxTotalSum = 0
   ...
   !---------------------------------!
   type(ElocAndPsiTermsLM), intent(inout) :: this
   real*8 :: ElocAndPsiTermsLM_Vx(this%EPTB%wfp%nParams)
   ...
   type(ElocAndPsiTermsLM), intent(inout) :: this
   real*8 :: ElocAndPsiTermsLM_VxyALL(this%EPTB%wfp%nParams,this%EPTB%wfp%nParams)
   integer nData(1),nTotalData(1),np,np2
   real*8 VxySum(this%EPTB%wfp%nParams,this%EPTB%wfp%nParams),VxyTotalSum(this%EPTB%wfp%nParams,this%EPTB%wfp%nParams)
   real*8 total(this%EPTB%wfp%nParams**2),vector(this%EPTB%wfp%nParams**2)
   np = this%EPTB%wfp%nParams
   np2 = np**2
   ...
   !----------------------------------!
   type(ElocAndPsiTermsLM), intent(inout) :: this
   real*8                                 :: ElocAndPsiTermsLM_Vxy(size(this%VxySum,1),size(this%VxySum,2))
   ElocAndPsiTermsLM_Vxy = 2*this%VxySum / this%EPTB%nData
   end function ElocAndPsiTermsLM_Vxy

end module ElocAndPsiTermsLMModule
