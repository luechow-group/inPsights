module ElocAndPsiTermsGenModule
   ...
   use global
   use WFParamsModule
   use ElocAndPsiTermsBaseModule
   implicit none

   type ElocAndPsiTermsGen
      private
      type(ElocAndPsiTermsBase) :: EPTB
      real*8, pointer :: fi(:) => null()       ! notation: Psi -> f, i.e. fi = Psi_i/Psi_0
      real*8, pointer :: fiEL(:) => null()     ! fiEL = Psi_i/Psi_0*E_L
      real*8, pointer :: ELi(:) => null()      ! ELi = E_L,i = \partial E_L / \partial p_i
      real*8, pointer :: fij(:,:) => null()    ! fij = Psi_ij / Psi_0
      real*8, pointer :: fifj(:,:) => null()   ! fifj = Psi_i/Psi_0 * Psi_j/Psi_0
      real*8, pointer :: fijEL(:,:) => null()
      real*8, pointer :: fifjEL(:,:) => null()
      real*8, pointer :: fiELj(:,:) => null()
...
contains
   ...
   !-------------------------------------------!
   real*8 function ElocAndPsiTermsGen_EMean(this)
   !-------------------------------------------!
   type(ElocAndPsiTermsGen), intent(inout) :: this
   ...
   !----------------------------------------------!
   real*8 function ElocAndPsiTermsGen_EMeanALL(this)
   !----------------------------------------------!
   type(ElocAndPsiTermsGen), intent(inout) :: this
   ...
   !-----------------------------------------!
   real*8 function ElocAndPsiTermsGen_var(this)
   !-----------------------------------------!
   type(ElocAndPsiTermsGen), intent(inout) :: this
   ...
   !--------------------------------------------!
   real*8 function ElocAndPsiTermsGen_varALL(this)
   !--------------------------------------------!
   type(ElocAndPsiTermsGen), intent(inout) :: this
   ...
   type(ElocAndPsiTermsGen), intent(inout) :: this
   real*8, optional, intent(out) :: fi(:)    ! for notation see type def.
   real*8, optional, intent(out) :: ELi(:)
   real*8, optional, intent(out) :: fiEL(:)
   real*8, optional, intent(out) :: fij(:,:)
   real*8, optional, intent(out) :: fifj(:,:)
   real*8, optional, intent(out) :: fijEL(:,:)
   real*8, optional, intent(out) :: fifjEL(:,:)
   real*8, optional, intent(out) :: fiELj(:,:)
   integer nData(1),nTotalData(1),np,np2,n,i,j
   real*8 total(this%EPTB%wfp%nParams**2),vector(this%EPTB%wfp%nParams**2),vsum(this%EPTB%wfp%nParams)
   np = this%EPTB%wfp%nParams
   np2 = np**2
   ...
   real*8, intent(out) :: fi(:),fiEL(:)  ! for notation see type def.
   integer nData(1),nTotalData(1),np,np2,n,i,j
   real*8 vsum(this%EPTB%wfp%nParams)
   np = this%EPTB%wfp%nParams
   nData(1) = this%EPTB%nData
...
end module ElocAndPsiTermsGenModule
