module ElocAndPsiTermsWEBFGSModule
   ...
   type ElocAndPsiTermsWEBFGS
      ...
      real*8          :: w = 0              ! weights (Psi/Psi0)**2
      real*8          :: wEL = 0            ! weighted Eloc
      real*8, pointer :: wk(:) => null()    ! deriv of w wrt p_k
      real*8, pointer :: wkEL(:) => null()  ! deriv of w wrt p_k x Eloc
      real*8, pointer :: wELk(:) => null()  ! w x deriv of Eloc
...
contains
   ...
   !----------------------------------------------------
      type(ElocAndPsiTermsWEBFGS), intent(inout) :: this
      real*8, intent(in)                      :: phi0    ! phi(p_0) original parameters
      real*8, intent(in)                      :: U0      ! U(p_0) original parameters
   ...
   !----------------------------------------------!
   real*8 function ElocAndPsiTermsWEBFGS_EMean(this)
   !----------------------------------------------!
   type(ElocAndPsiTermsWEBFGS), intent(inout) :: this
   ...
   !--------------------------------------------------!
   real*8 function ElocAndPsiTermsWEBFGS_EMeanALL(this)
   !--------------------------------------------------!
   type(ElocAndPsiTermsWEBFGS), intent(inout) :: this
   ...
   !---------------------------------------------!
   real*8 function ElocAndPsiTermsWEBFGS_var(this)
   !---------------------------------------------!
   type(ElocAndPsiTermsWEBFGS), intent(inout) :: this
   ...
   !-----------------------------------------------!
   real*8 function ElocAndPsiTermsWEBFGS_varALL(this)
   !-----------------------------------------------!
   type(ElocAndPsiTermsWEBFGS), intent(inout) :: this
   ...
   type(ElocAndPsiTermsWEBFGS), intent(inout) :: this
   real*8, intent(out) :: w,wEL,wk(:),wkEL(:),wELk(:)  ! for notation see type def.
...
end module ElocAndPsiTermsWEBFGSModule
