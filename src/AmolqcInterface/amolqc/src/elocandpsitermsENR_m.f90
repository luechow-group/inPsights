module ElocAndPsiTermsENRModule
...
contains
   ...
   !-------------------------------------------!
   real*8 function ElocAndPsiTermsENR_EMean(this)
   !-------------------------------------------!
   type(ElocAndPsiTermsENR), intent(inout) :: this
   ...
   !----------------------------------------------!
   real*8 function ElocAndPsiTermsENR_EMeanALL(this)
   !----------------------------------------------!
   type(ElocAndPsiTermsENR), intent(inout) :: this
   ...
   !-----------------------------------------!
   real*8 function ElocAndPsiTermsENR_var(this)
   !-----------------------------------------!
   type(ElocAndPsiTermsENR), intent(inout) :: this
   ...
   !--------------------------------------------!
   real*8 function ElocAndPsiTermsENR_varALL(this)
   !--------------------------------------------!
   type(ElocAndPsiTermsENR), intent(inout) :: this
   ...
   type(ElocAndPsiTermsENR), intent(inout) :: this
   real*8, intent(out) :: fi(:),ELi(:),fiEL(:)  ! for notation see type def.
   real*8, intent(out) :: fij(:,:),fifj(:,:),fijEL(:,:),fifjEL(:,:),fiELj(:,:)
...
end module ElocAndPsiTermsENRModule
