module OptimizeParamsBFGSModule

   use global
   use RWSampleModule
   use ElocAndPsiTermsENRModule
   use WFParamsModule
   use qmc, only : qmc_run
   implicit none
...
contains
   ...
   subroutine parabolaMin(x0,y0,x1,y1,x2,y2,xmin,ymin,alpha)
      ...
      real*8, intent(inout) :: xmin,ymin,alpha
...
end module OptimizeParamsBFGSModule
