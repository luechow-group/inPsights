module refValStrModule
   ...
   type, extends(referenceContainer) :: refContainerValStr
      real*8            :: valueThreshold = 1.d-3       ! identify function values as equal if diff is smaller
      integer           :: distMode = SPINPERM
      real*8            :: sameThreshold = 1.d-2       ! identify structures as equal if diff is smaller
   contains
