module assign
   ...
   use global, only: ne,iul
   use wfdata, only: ncenter,nalpha,nbeta,atoms,calcNucElecDists
   ...
   real*8,allocatable   :: mXRef(:), mYRef(:), mZRef(:)
...
contains
   ...
   !-----------------------------------------------!
      ...
      real*8                        :: x_tmp2(ne),y_tmp2(ne),z_tmp2(ne)
      real*8                        :: F,Ftmp
      integer                       :: nomax,noel
