module aomo_task
  ...
  type bf_t
    ...
    integer :: type = 0
    real*8 :: aocut = 0d0
    real*8, allocatable :: alpha(:), coeff(:), moc(:)
  end type
...
contains
  ...
  subroutine p_calc(bf, i, r2, dx, dy, dz)
    ...
    integer :: j, d
    real*8 :: alp,u,ux
    real*8 :: dx2, dy2, dz2, dxdy, dxdz, dydz
    real*8 :: tmp,tmpp(3,5)
  ...
  subroutine d_calc(bf, i, r2, dx, dy, dz)
    ...
    integer :: ic, j, d
    real*8 :: alp,u,ux
    real*8 :: dx2,dy2,dz2,dxdy,dxdz,dydz,dxdydz,dy2dx,dx2dy,dx2dz,dz2dx,dy2dz,dz2dy
    real*8 :: tmp,tmpd(6,5)
  ...
  subroutine f_calc(bf, i, r2, dx, dy, dz)
    ...
    integer :: ic, j, d
    real*8 :: alp,u,ux
    real*8 :: dx2,dy2,dz2,dxyz
    real*8 :: tmp,tmpf(10,5)
