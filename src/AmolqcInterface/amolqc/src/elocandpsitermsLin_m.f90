module ElocAndPsiTermsLinModule
...
contains
   ...
   !-------------------------------------------!
   real*8 function ElocAndPsiTermsLin_eRef(this)
   !-------------------------------------------!
   type(ElocAndPsiTermsLin), intent(inout) :: this
   ...
   !-------------------------------------------!
   real*8 function ElocAndPsiTermsLin_EMean(this)
   !-------------------------------------------!
   type(ElocAndPsiTermsLin), intent(inout) :: this
   ...
   !----------------------------------------------!
   real*8 function ElocAndPsiTermsLin_EMeanALL(this)
   !----------------------------------------------!
   type(ElocAndPsiTermsLin), intent(inout) :: this
   ...
   !-----------------------------------------!
   real*8 function ElocAndPsiTermsLin_var(this)
   !-----------------------------------------!
   type(ElocAndPsiTermsLin), intent(inout) :: this
   ...
   !--------------------------------------------!
   real*8 function ElocAndPsiTermsLin_varALL(this)
   !--------------------------------------------!
   type(ElocAndPsiTermsLin), intent(inout) :: this
   ...
   real*8, intent(out) :: fifj(:,:),fifjEL(:,:),fiELj(:,:)
...
end module ElocAndPsiTermsLinModule
