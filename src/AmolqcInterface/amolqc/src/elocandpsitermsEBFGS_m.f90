module ElocAndPsiTermsEBFGSModule
...
contains
   ...
   !----------------------------------------------!
   real*8 function ElocAndPsiTermsEBFGS_EMean(this)
   !----------------------------------------------!
   type(ElocAndPsiTermsEBFGS), intent(inout) :: this
   ...
   !-------------------------------------------------!
   real*8 function ElocAndPsiTermsEBFGS_EMeanALL(this)
   !-------------------------------------------------!
   type(ElocAndPsiTermsEBFGS), intent(inout) :: this
   ...
   !--------------------------------------------!
   real*8 function ElocAndPsiTermsEBFGS_var(this)
   !--------------------------------------------!
   type(ElocAndPsiTermsEBFGS), intent(inout) :: this
   ...
   !-----------------------------------------------!
   real*8 function ElocAndPsiTermsEBFGS_varALL(this)
   !-----------------------------------------------!
   type(ElocAndPsiTermsEBFGS), intent(inout) :: this
...
end module ElocAndPsiTermsEBFGSModule
