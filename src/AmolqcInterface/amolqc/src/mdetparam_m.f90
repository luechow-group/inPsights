...
module mdetparam
  use global, only: ne
  use wfdata, only: nalpha,nbeta,ndet,ncsf
  use mdet, only: cci,ndets,ccsf,deter,dgrad,dlapli
  implicit none
  public
  ...
  real*8, allocatable, target :: fk(:)
  real*8, allocatable, target :: fkgrad(:,:)
  real*8, allocatable, target :: fklapl(:)
  real*8, allocatable, target :: fklapli(:,:)
