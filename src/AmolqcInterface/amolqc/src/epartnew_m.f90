...
contains
   ...
   subroutine epart_add(rwp,asgn,dIdx)
   !----------------------------!
      ...
      real*8            :: Ekin(ne),Vee(ne,ne),Vne(ncenter,ne)
      real*8            :: ee_tmp(ne,ne),ne_tmp(ncenter,ne),kin_tmp(ne)
      real*8            :: weight
      real*8, allocatable :: Eintra(:),Einter(:,:)
      ...
      call Ekini(rwp,kin_tmp)
      call EVee(rwp,ee_tmp)
      call EVne(rwp,ne_tmp)
      weight = wgt(rwp)
   ...
   !-----------------------------!
      ...
      real*8  :: etot
      real*8  :: Ekin(ne,mKMax),Vee(ne,ne,mKMax),Vne(ncenter,ne,mKMax)
      real*8  :: Ekinsd(ne,mKMax),Veesd(ne,ne,mKMax),Vnesd(ncenter,ne,mKMax)
      real*8  :: x(ne),y(ne),z(ne)
      real*8, allocatable :: Eintra(:), Einter(:,:), Eintrasd(:), Eintersd(:,:)  
      integer i,j,n
      integer*8 nd
   ...
   real*8 function chemGroup_intraEnergy(self,ekin,vne,vee)
      class(chemGroup), intent(in) :: self
      real*8                      :: ekin(:),vne(:,:),Vee(:,:)
      real*8 sum
      integer i,j,a
   ...
   real*8 function chemGroup_interEnergy(self,other,ekin,vne,vee)
      class(chemGroup), intent(in) :: self
