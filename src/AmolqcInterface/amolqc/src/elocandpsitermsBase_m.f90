module ElocAndPsiTermsBaseModule
...
contains
   ...
   !--------------------------------------------!
   real*8 function ElocAndPsiTermsBase_eRef(this)
   !--------------------------------------------!
   type(ElocAndPsiTermsBase), intent(inout) :: this
   ...
   !---------------------------------------------!
   real*8 function ElocAndPsiTermsBase_EMean(this)
   !---------------------------------------------!
   ...
   !------------------------------------------------!
   real*8 function ElocAndPsiTermsBase_EMeanALL(this)
   !------------------------------------------------!
   type(ElocAndPsiTermsBase), intent(in) :: this
   integer nData(1),nTotalData(1)
   real*8 ESum(1), ETotalSum(1)
   ESum(1) = this%elocSum
   ETotalSum(1) = 0
   ...
   !-------------------------------------------!
   real*8 function ElocAndPsiTermsBase_var(this)
   !-------------------------------------------!
   type(ElocAndPsiTermsBase), intent(inout) :: this
   ...
   !----------------------------------------------!
   real*8 function ElocAndPsiTermsBase_varRef(this)
   !----------------------------------------------!
   type(ElocAndPsiTermsBase), intent(inout) :: this
   ...
   !----------------------------------------------!
   real*8 function ElocAndPsiTermsBase_varALL(this)
   !----------------------------------------------!
   type(ElocAndPsiTermsBase), intent(inout) :: this
   integer nData(1),nTotalData(1)
   real*8 ESum(1), ETotalSum(1)
   real*8 E2Sum(1), E2TotalSum(1)
   ESum(1) = this%elocSum
   ETotalSum(1) = 0
   call myMPIReduceSumDouble(ESum,ETotalSum,1)
   ...
   !-------------------------------------------------!
   real*8 function ElocAndPsiTermsBase_varRefALL(this)
   !-------------------------------------------------!
   type(ElocAndPsiTermsBase), intent(inout) :: this
   integer nData(1),nTotalData(1)
   real*8 ESum(1), ETotalSum(1)
...
end module ElocAndPsiTermsBaseModule
