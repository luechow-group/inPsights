module refPosModule
   ...
   type, extends(referenceContainer) :: refContainerPos      ! like Struct but electrons are permuted for max likeness and averaged
      ...
      real*8            :: simmaxThreshold = 0.1d0         ! for "max positions": similar elec position if distance smaller
      real*8, allocatable  :: maxrefpos(:,:,:)               ! collect "max positions" of alpha/beta electrons for each reference
...
contains
   ...
   subroutine refcp_create(this,listLength,doSortFreq,refFile,simThreshold,simmaxThreshold,ire,exclFile)
      ...
      real*8 x(ne),y(ne),z(ne),ri(3),d,f
   ...
   subroutine refcp_insert(this,r)
      ...
      real*8                                   :: f,f0,wgt,dist,d,thr,maxdist
